...
export const SOCKET_EMIT_SET_STATION_ID = 'set-viewed-station'
export const SOCKET_EVENT_EDIT_STATION = 'edit-station'
export const SOCKET_EVENT_SAVE_STATION = 'save-station'
