...
import { FB_API_KEY, AUTH_DOMAIN, PROJECT_ID, STORAGE_BUCKET, MESSAGING_SENDER_ID, APP_ID, MEASUREMENT_ID } from './credentials'
...
export const FIREBASE_CONFIG ={
    ...
    measurementId: import.meta.env.MEASUREMENT_ID || MEASUREMENT_ID,
  }
