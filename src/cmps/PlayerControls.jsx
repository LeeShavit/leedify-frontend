    ...
    <div className='player-controls'>
      ...
      <div className='player-controls-content'>
        <div className='player-controls-buttons'>
          ...
          <button onClick={isPlaying ? handlePause : handlePlay} className={`play ${isPlaying ? 'is-playing' : ''}`}>
        ...
        <div className='progress'>
          <span className='progress-time'>{(playerRef.current && formatTime(currentTime)) || '0:00'}</span>
          <input
            type='range'
            min='0'
            max='100'
            value={(currentTime / playerRef.current?.getDuration()) * 100 || 0}
            onChange={handleProgressClick}
            style={{ '--slider-value': `${(currentTime / playerRef.current?.getDuration()) * 100 || 0}%` }}
          ></input>
