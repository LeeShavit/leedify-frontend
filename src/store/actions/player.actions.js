import {
    LOADING_START, LOADING_DONE, SET_CURRENT_SONG, SET_IS_PLAYING,
    ADD_TO_QUEUE, ADD_TO_QUEUE_NEXT, REMOVE_FROM_QUEUE, CLEAR_QUEUE,
    TOGGLE_SHUFFLE, SET_REPEAT_MODE, PLAY_NEXT, PLAY_PREV, REPLACE_QUEUE
