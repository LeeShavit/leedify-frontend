export const AddIcon = ({ className }) => (
    <svg role='img' height='16' width='16' aria-hidden='true' className={className} viewBox='0 0 16 16'>
        <path
            fill="currentColor"
...
<path fill="currentColor" d="M400-280v-400l200 200-200 200Z"/></svg>
)

export const AddToQueue = ({ className }) => (
    <svg role='img' height='16' width='16' aria-hidden='true' className={className} viewBox='0 0 16 16'>
        <path
            fill="currentColor"
...
export const GoToRadio = ({ className }) => (
    <svg role='img' height='16' width='16' aria-hidden='true' className={className} viewBox='0 0 16 16'>
        <path fill="currentColor"
            d="M5.624 3.886A4.748 4.748 0 0 0 3.25 8c0 1.758.955 3.293 2.375 4.114l.75-1.3a3.249 3.249 0 0 1 0-5.63l-.75-1.298zm4.001 1.299.75-1.3A4.748 4.748 0 0 1 12.75 8a4.748 4.748 0 0 1-2.375 4.114l-.75-1.3a3.249 3.249 0 0 0 0-5.63zM8 6.545a1.455 1.455 0 1 0 0 2.91 1.455 1.455 0 0 0 0-2.91z"></path>
        <path fill="currentColor"
...
export const Embed = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" height='16' width='16' viewBox="0 0 16 16" className={className}>
        ...
        />
        <path
            d="M7.4-4.8l-4.8-4.8 4.8-4.8 1.14 1.14-3.68 3.68 3.66 3.66-1.12 1.12Zm6.4 0-1.14-1.14 3.68-3.68-3.66-3.66 1.12-1.12 4.8 4.8-4.8 4.8Z"
            fill="currentColor"
            transform="translate(2.5, 16) scale(0.7)"
        />
    </svg>
)